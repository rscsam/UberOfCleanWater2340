    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ContextCompat.checkSelfPermission(this, android.Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            if (ActivityCompat.shouldShowRequestPermissionRationale(this, android.Manifest.permission.ACCESS_FINE_LOCATION)) {
                Toast.makeText(this, "Location permission need to autogenerate Latitude and Longitude.", Toast.LENGTH_LONG).show();
            } else {
    ...
    private void setLatLong () {
        if (ActivityCompat.checkSelfPermission(this, android.Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
            ...
            if (loc != null) {
                ...
                latitudeET.setText(lat.toString());
                longitudeET.setText(lng.toString());
            } else {
                Toast.makeText(this, "Location could not be autogenerated. Is GPS enabled?", Toast.LENGTH_LONG).show();
            }
        }
    }
